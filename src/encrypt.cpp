...
// Lookup tables for 2 & 3 from: https://en.wikipedia.org/wiki/Rijndael_MixColumns
// Lookup table for byte multiplied by 2 
...
// Lookup table for byte multiplied by 3
...
void keyExpansion(unsigned char* key, unsigned char* expansion, unsigned char keysize) {
	...
	// for (int i = 0; i < 16 * ((keysize / 4) + 7); i++)
	// {
	// 	std::cout << std::hex << (int)expansion[i];
	// 	std::cout << " ";
	// }
	// std::cout << std::endl;
}
